...
RELOAD_SAMPLES = 0  # Not Yet Implemented
...
SHIFT_BUTTONS = [BANK_SELECTOR,METRONOME,TRACK_LOAD_SHIFT, TRACK_SAVE_SHIFT, MODE_SHIFT,PAGE_SELECTOR,LOOP_ACTIVATOR_SHIFT]
